      ...
      - **USER:**
        ...
        - **CLIENT**
          ...
          - **IMPROVEMENTS:**
            ...
            - [ ] Router to swap Client and Member entities (constrain PERMITION ADMIN )
            - [ ] Router to change address
        ...
        - **MEMBER**
          ...
          - **IMPROVEMENTS:**
            ...
            - [ ] Router to change CLIENT reference (constrain PERMITION ADMIN )
